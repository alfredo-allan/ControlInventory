...
import { Search, Trash2, Package, Calendar, User, Barcode, AlertTriangle, Store } from 'lucide-react'
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8 max-w-full sm:max-w-3xl md:max-w-6xl">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-semibold text-foreground mb-1 sm:mb-2">Deletar Produto</h1>
        <p className="text-sm sm:text-base text-muted-foreground">Busque e remova produtos do sistema</p>
      </div>
